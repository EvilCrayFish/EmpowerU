...
def test_get_lesson_line():
    ...
    page1 = CreateLessonPage(CreateLessonPage.master, "AI", "Intro to AI", home_page, app_user)
    ...
    page2 = CreateLessonPage(CreateLessonPage.master, "AI", "Machine Learning", home_page, app_user)
    ...
    page3 = CreateLessonPage(CreateLessonPage.master, "AI", "Deep Learning", home_page, app_user)
    ...
    page4 = CreateLessonPage(CreateLessonPage.master, "AI", "Natural Language Processing?", home_page, app_user)
    ...
    page5 = CreateLessonPage(CreateLessonPage.master, "PY", "Hello World!", home_page, app_user)
    ...
    page6 = CreateLessonPage(CreateLessonPage.master, "PY", "Data Types and Variables", home_page, app_user)
    ...
    page7 = CreateLessonPage(CreateLessonPage.master, "PY", "Control Flow", home_page, app_user)
    ...
    page8 = CreateLessonPage(CreateLessonPage.master, "PY", "Functions and Modules", home_page, app_user)
    ...
    page9 = CreateLessonPage(CreateLessonPage.master, "IS", "Intro to Information Systems", home_page, app_user)
    ...
    page10 = CreateLessonPage(CreateLessonPage.master, "IS", "Database Management Systems", home_page, app_user)
    ...
    page11 = CreateLessonPage(CreateLessonPage.master, "IS", "Systems Development Life Cycle", home_page, app_user)
    ...
    page12 = CreateLessonPage(CreateLessonPage.master, "IS", "IS Fundamentals", home_page, app_user)
