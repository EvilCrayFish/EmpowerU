...
def get_lesson_line():
    ...
    page1 = EditLessonPage(EditLessonPage.master, "AI", "Intro to AI", home_page, app_user)
    ...
    page2 = EditLessonPage(EditLessonPage.master, "AI", "Machine Learning", home_page, app_user)
    ...
    page3 = EditLessonPage(EditLessonPage.master, "AI", "Deep Learning", home_page, app_user)
    ...
    page9 = EditLessonPage(EditLessonPage.master, "IS", "Intro to Information Systems", home_page, app_user)
    ...
    page10 = EditLessonPage(EditLessonPage.master, "IS", "Database Management Systems", home_page, app_user)
    ...
    page12 = EditLessonPage(EditLessonPage.master, "IS", "IS Fundamentals", home_page, app_user)
