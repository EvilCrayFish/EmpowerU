...
class Layout(tk.Frame):
    ...
    def AI_tab_content(self):
        tk.Label(self.AI_tab, text="Artificial Intelligence", font=('Arial', 14)).pack(pady=20)
        tk.Label(self.AI_tab, text="Mentor: James V", font=('Arial', 12)).pack(pady=20)

        tk.Button(self.AI_tab, text="Lesson 1", font=('Arial', 14)).pack(pady=20)
    
    def IS_tab_content(self):
        tk.Label(self.IS_tab, text="Information Security", font=('Arial', 14)).pack(pady=20)
        tk.Label(self.IS_tab, text="Mentor: James V", font=('Arial', 12)).pack(pady=20)
