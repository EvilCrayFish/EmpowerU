...
Contains testing for the CreateLessonPage window
"""
...
def test_get_lesson_line():
    ...
    page1 = CreateLessonPage(None, "AI", "Intro to AI", home_page, app_user)
    ...
    page2 = CreateLessonPage(None, "AI", "Machine Learning", home_page, app_user)
    ...
    page5 = CreateLessonPage(None, "PY", "Hello World!", home_page, app_user)
    ...
    page6 = CreateLessonPage(None, "PY", "Data Types and Variables", home_page, app_user)
    ...
    page7 = CreateLessonPage(None, "PY", "Control Flow", home_page, app_user)
    ...
    page8 = CreateLessonPage(None, "PY", "Functions and Modules", home_page, app_user)
    ...
    page9 = CreateLessonPage(None, "IS", "Intro to Information Systems", home_page, app_user)
    ...
    page10 = CreateLessonPage(None, "IS", "Database Management Systems", home_page, app_user)
    ...
    page11 = CreateLessonPage(None, "IS", "Systems Development Life Cycle", home_page, app_user)
    ...
    page12 = CreateLessonPage(None, "IS", "IS Fundamentals", home_page, app_user)
    ...
    page13 = CreateLessonPage(None, "Info Sec", "IS Basics", home_page, app_user)
    assert not page13.get_lesson_line() == ["IS", "", "", ""]

    page14 = CreateLessonPage(None, "Artificial intelligence", "AI Basics", home_page, app_user)
    assert not page14.get_lesson_line() == ["AI", "Large Language Models", "LLMs are cool", "Complete"]

    page15 = CreateLessonPage(None, "Python", "Python Basics", home_page, app_user)
    assert not page15.get_lesson_line() == ["PY", "Python is good for beginners", "Hello World", "Incomplete"]

    page16 = CreateLessonPage(None, "PY", "Functions and Modules", home_page, app_user)
