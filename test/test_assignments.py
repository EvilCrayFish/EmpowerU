...
def test_read_assignments():
    ...
    assert Assignment("Information Security Assignment 1", "Information Security", "Incomplete") == assignments_page.read_assignments(None, None)[0]
    assert Assignment("Python Assignment 1", "Programming", "Complete") == assignments_page.read_assignments(None, None)[1]
    assert Assignment("Python Assignment 2", "Programming", "Incomplete") == assignments_page.read_assignments(None, None)[2]
    assert Assignment("AI Assignment 2", "AI", "Complete") == assignments_page.read_assignments(None, None)[3]
    assert Assignment("AI Assignment 1", "AI", "Complete") == assignments_page.read_assignments(None, None)[4]
    ...
    # assert [] == assignments_page.read_assignments("Large language models")
    # assert not [Assignment()] == assignments_page.read_assignments()
    # assert not [Assignment()] == assignments_page.read_assignments()
    # assert not [Assignment()] == assignments_page.read_assignments()
    # assert not [Assignment()] == assignments_page.read_assignments()
    # assert not [Assignment()] == assignments_page.read_assignments()
